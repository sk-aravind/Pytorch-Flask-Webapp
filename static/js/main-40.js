...
$(document).ready(function() {
	...
	var csvfile_import_122860 = "static/csv/results-20-combined-2.csv";
...
// cssHeader:"header",cssAsc:"headerSortUp",cssDesc:"headerSortDown"
...
function(){
	...
	this.defaults={
		...
		cancelSelection:true,sortList:[],headerList:[],
		dateFormat:"us",decimal:'/\.|\,/g',
		onRenderHeader:null,
		selectorHeaders:'thead th',debug:false
					...
					if ((lineCount == options.startLine) && (typeof(options.headers) == 'undefined')) {
						...
						if (items.length > 1) {
							...
							$.each(items, function(itemCount, item) {
								if (itemCount == 0){
									tableHTML += '<td class="' + options.tdClass + '">' + ' <img src ="' + item +  '"> </img></a> ' + '</td>';
								} else {
